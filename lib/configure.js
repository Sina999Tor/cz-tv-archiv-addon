...
<body>
  <div class="card">
    ...
    <p class="subtitle">Doplněk pro Stremio / Nuvio — katalog českých a slovenských filmů a seriálů z TMDB. Streamy řeší tvé ostatní nainstalované addony (Webshare, Hellspy, ...). Zadej svůj vlastní TMDB API klíč a vygeneruj si instalační odkaz — klíč se ukládá pouze v samotné URL adrese doplňku, nikde jinde se neukládá.</p>
