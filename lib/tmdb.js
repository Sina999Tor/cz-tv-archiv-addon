...
// stránku i když se stránky překrývají).
...
// nízký záměrně (jsou nové), proto se tam filtr nepoužívá.
function voteCountFloor(genre) {
  if (genre === 'Novinky') return {};
...
const PAGE_SIZE = 20;
const MAX_TMDB_PAGES = 100; // pojistka proti nekonečné smyčce (2000 syrových záznamů)
...
// --- KATALOG: FILMY ---
export async function discoverMovies({ genre = 'Populární', search = '', skip = 0, country = 'CZ + SK', year = '' }) {
...
// --- KATALOG: SERIÁLY ---
export async function discoverSeries({ genre = 'Populární', search = '', skip = 0, country = 'CZ + SK', year = '' }) {
